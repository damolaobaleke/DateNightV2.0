...
package com.ltd_immersia_datenight.utils.stripe.config.checkoutonly;
...
public class CheckOutActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stripe = new Stripe(getApplicationContext(),
                Objects.requireNonNull("pk_test_51IEOyvKzXEZpc2WIIhHL4e7Z9885t8iFLNgPgBnQSyz70BNKoYEhHcfhUYtwShJgl1tmqJRV3BEHQ0luhRUbPQ4c00iW4180mZ")
        );
        startCheckout();
    }
