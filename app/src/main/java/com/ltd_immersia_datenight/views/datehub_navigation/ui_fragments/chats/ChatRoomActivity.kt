...
class ChatRoomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val chatParticipantUsername = intent.getStringExtra(IntentConstants.PARTICIPANT_USER_NAME_EXTRA)
        ...
        chatRoomLayoutManager.stackFromEnd = true // Make sure bottom of recycler view is displayed on activity launch
