...
public class DateModel {
    ...
    public DateModel(String id, String password, String creator,
                     HashMap<String, String> participants,
                     HashMap<String, String> participantUsernames,
                     Timestamp timeCreated, Timestamp dateTime, String linkedExperienceId,
                     HashMap<String, String> participantStatus) {
        this.id = id;
    ...
    public void setParticipantUsernames(
            HashMap<String, String> participantUsernames) {
        this.participantUsernames = participantUsernames;
    }
